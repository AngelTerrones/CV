...
\item[] Maestría,
        ...
        \item Área de Estudio: Navegación en Enjambre y Robótica Móvil.
        \end{innerlist}
...
\begin{outerlist}
    \item[] \textit{Ingeniero de Software/Desarrollador}
            \hfill \textbf{Febrero 2025 a la fecha}
            \begin{innerlist}
                \item Desarrollo de diferentes soluciones informáticas.
            \end{innerlist}

\end{outerlist}

\textbf{Consultor en Sento Electronics}
\begin{outerlist}
    \item[] \textit{Ingeniero de Software/Desarrollador}
            \hfill \textbf{Enero 2024 a Febrero 2025}
            \begin{innerlist}
...
\section{Projectos como contratista}
\begin{innerlist}
...
%
\begin{innerlist}
    \item C/C$++$, Rust, Python, UNIX shell scripting, GNU make, CMake.
