...
\textbf{Navigation algorithms for multi-robot systems:} distributed algorithms,
autonomous systems, artificial potential fields, swarm navigation, cooperative
robots, emergent behavior, control, movement prediction

\textbf{Machine learning:} artificial neural networks, deep learning, genetic
algoritms.

\textbf{Computer architecture:} design of pipelined and multi-core processors.
...
\item[] M.S.,
        ...
        \item Advisers:
              \href{http://www.labc.usb.ve/mecatronica/quienes_somos.html}
                   {Ph.D. Gerardo Fernández-Lopez} and
              \href{http://www.labc.usb.ve/mecatronica/quienes_somos.html}
                   {MSc. Leonardo Fermín}
...
\begin{innerlist}
    ...
    Implementation of RV32IM ISA. using MyHDL.
\end{innerlist}
...
\begin{innerlist}
    ...
    \item \href{https://bitbucket.org/NHT/os-twr/wiki/Home}{OS-TWR}: A Operating
    System for the MCF51CN128 microcontroller.
    \item \href{https://bitbucket.org/NHT/cudasmr}{CUDASMR}: A multi-robot simulator
    using CUDA. Developed as a tool for my Master Thesis.
    \item \href{https://bitbucket.org/NHT/smr3}{SMR3}: A multi-robot simulator.
    Developed as a tool for my Master Thesis.
    \item \href{https://github.com/angelterrones/antares}{Antares}: Implementation
    of the MIPS I RISC Processor.
    \item \href{https://github.com/angelterrones/algol}{Algol}: Microarchitectural
    Implementation of RV32IM ISA (under development).
...
Contractor projects:
\begin{innerlist}
\item Port a code base to new device (2016 - in course).
  \begin{innerlist}
...
\begin{innerlist}
    ...
    Freescale MCU's, Atmel MCU's)
    \item FPGA development: Xilinx ISE, Icarus Verilog, MyHDL.
    \item Experience with RTAI (Real Time Application Interface for Linux).
\end{innerlist}
...
\begin{innerlist}
    ...
    \item Experience with OGRE 3D (Open Source 3D Graphics Engine).
    \item Experience with the OpenCV library.
\end{innerlist}
...
%
\begin{innerlist}
    \item Eclipse, Microsoft Visual Studio, Qt Creator.
...
%
\begin{innerlist}
    \item Microsoft Windows family, Linux (Ubuntu family, Arch Linux, OpenSuSE)
\end{innerlist}

\section{References Available to Contact}

\href
{http://www.labc.usb.ve/mecatronica/quienes_somos.html}
{\textbf{Ph.D. Gerardo Fernández-López}}\\
Caracas, Venezuela\\
...
\begin{innerlist}
    ...
    \item President of \href{http://www.pts.org.ve/portal/index.php/en/}{Sartenejas Technological Park}
