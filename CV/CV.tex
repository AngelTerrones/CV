...
\begin{innerlist}
    ...
    Freescale, Atmel, STM32)
    \item FPGA development: Xilinx ISE, Xilinx Vivado, Microsemi Libero SoC,
      Verilator, Icarus Verilog, myHDL.
\end{innerlist}
